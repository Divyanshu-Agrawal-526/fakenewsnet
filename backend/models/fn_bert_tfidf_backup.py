...
Architecture:
- BERT embeddings (1024 dimensions) for contextual understanding
- TF-IDF features (5000 dimensions) for statistical features
- BiLSTM layer (256 units) with dropout 0.2
- CNN layer (64 filters, kernel size 128)
...
class FNBertTfidfModel(nn.Module):
    ...
    def __init__(self, 
        ...
        self.feature_fusion = nn.Linear(bert_dim + tfidf_features.shape[1], bert_dim)
